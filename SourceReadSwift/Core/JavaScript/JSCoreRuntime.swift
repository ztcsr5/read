...
final class JSCoreRuntime {
    ...
    private func installBaseBridge() {
        ...
        var java = (typeof java === 'undefined' || java === null) ? {} : java;
        // SourceRead's JSON/HTML hybrid helper.  Keep both constructor and
        // factory spellings used by Android Legado sources.
        var JXNode = (typeof JXNode === 'undefined' || JXNode === null) ? function(value) { return __nativeJXNode.create(value); } : JXNode;
        ...
        var cookie = (typeof cookie === 'undefined' || cookie === null) ? {} : cookie;
        ...
        var CryptoJS = (typeof CryptoJS === 'undefined' || CryptoJS === null) ? {} : CryptoJS;
        ...
        var Packages = (typeof Packages === 'undefined' || Packages === null) ? {} : Packages;
